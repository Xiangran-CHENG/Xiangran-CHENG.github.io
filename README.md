...
- The group site uses a black, white and neutral-gray palette, including navigation accents, buttons, footers, the gallery viewer and favicon. The Home hero displays the existing artwork in grayscale through CSS; original gallery artwork and downloadable assets retain their colors.
