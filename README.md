...
- `assets/materials-core-philosophy-2026.png` (1672 × 941) is an AI-generated conceptual illustration created for the group: societal needs, material targets, synthesis pathways and functional validation connected by experimental feedback. It is displayed uncropped at full content width in Home's Our Vision section, with a dark caption panel and image-viewer and download links. The hero PNG loads eagerly; the strategy SVG loads lazily. The HTML/CSS materials-development map leads the Big Picture section. The illustration expresses research goals, not measured results.
