...
- Home (`group/index.html`) leads with the vision "Build the materials we need." and mission "Understand formation. Guide synthesis." It connects societal needs to reliable synthesis and functional validation, with synthesizability as the core scientific question and three connected directions. The synthesis-gap figure, selected publications and team information ground that narrative. Its page-specific styles live in `group/home.css`. Research (`group/research.html`), People (`group/people.html`) and Join us (`group/join.html`) are separate pages; edit their corresponding content there. All group pages are in English and do not read the personal homepage's saved language preference.
