...
The personal homepage at `index.html` uses a compact introduction, linked profiles, a year-aligned biography, research illustrations and selected publications. The typography and timeline draw on the owner's Karpathy homepage reference; no reference-site content or images are reused. It remains photo-free, with photographs accessible through the gallery link. Navigation is always visible on mobile.
