...
- `assets/materials-core-philosophy-2026.png` (1672 × 941) is an AI-generated conceptual illustration created for the group: societal needs, material targets, synthesis pathways and functional validation connected by experimental feedback. It is displayed uncropped in Home's expandable supporting illustrations. The HTML/CSS materials-development map leads the Big Picture section. The illustration expresses research goals, not measured results.
